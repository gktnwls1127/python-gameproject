...
# 화면 타이틀 설정
pygame.display.set_caption("Python Game") # 게임 이용

# FPS
clock = pygame.time.Clock()

# 배경 이미지 불러오기
background = pygame.image.load("C:/Users/user/Desktop/python-gameproject/background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/user/Desktop/python-gameproject/character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/user/Desktop/python-gameproject/enemy.png")
...
# 10 fps : 1초 동안에 10번 동작 -> 1번에 몇만큼 이동? 10 만큼! 10 * 10 = 100
